...
(function() {
    ...
    function load(urlOrArr) {
        if(urlOrArr instanceof Array) {
             ...
             * loop through each value and call image
             ...
             * assume the value is a string and call image loader
             * directly.
             */
            _load(urlOrArr);
        }
    ...
    function _load(url) {
        if(resourceCache[url]) {
             ...
             * within the cache; need to load this image.
             */
            var img = new Image();
            img.onload = function() {
                /* Once the image has properly loaded, add it to the cache.
                 * Return this image if attempting to load this file in the future.
                 */
    ...
    /* This is used to grab references to images known to
